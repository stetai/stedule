...
- 260721, **v0.5.5-alpha**: Event opacity, now indicator and today highlighting now update real-time; fixed status message overflowing; decreased min event size to 15 min
