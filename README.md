...
- 260902, **v0.6.1-alpha**: Added swipe navigation
- 260827, **v0.6.0-alpha**: Added all-day functionality; fixed major drag-and-drop bugs
...
Navigate to `stedule/frontend/` and run the following line in a terminal:
```
